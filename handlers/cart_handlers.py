...
@dispatcher.message_handler(commands=['cart'], state=[LoginState, MakeOrderState, ReviewState])
...
@dispatcher.message_handler(commands=['add'], state=[LoginState, MakeOrderState, ReviewState])
...
@dispatcher.message_handler(commands=['remove'], state=[LoginState, MakeOrderState, ReviewState])
...
@dispatcher.message_handler(commands=['change'], state=[LoginState, MakeOrderState, ReviewState])
